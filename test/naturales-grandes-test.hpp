 ...
 * Ultima revisión: 21 de octubre de 2022
 ...
 *       «convertir», invocada con el argumento «n», calcula el valor
 *       correcto «valorEsperado». En caso negativo, informa
 *       también acerca del valor incorrecto que calcula la función.
 */
 ...
 * Post: Escribe un mensaje en pantalla informando acerca de si la función
 *       «sumar», invocada con los argumentos «a» y «b», calcula el valor
 *       correcto «valorEsperado». En caso negativo, informa
 *       también acerca del valor incorrecto que calcula la función.
 */
 ...
 * Post: Escribe un mensaje en pantalla informando acerca de si la función
 *       «valor», invocada con el argumento «numero», devuelve el valor
 *       correcto «valorEsperado». En caso negativo, informa también acerca
 *       del valor incorrecto que devuelve la función.
 */
 ...
 * Post: Escribe un mensaje en pantalla informando acerca de si la función
 *       «calcularImagen», invocada con el argumento «numero», calcula el
 ...
 * Post: Escribe un mensaje en pantalla informando acerca de si la función
 *       «esCapicua», invocada con el argumento «numero», devuelve el valor
 *       correcto «valorEsperado». En caso negativo, informa también acerca
 *       del valor incorrecto que devuelve la función.
 */
 ...
 * Post: Escribe un mensaje en pantalla informando acerca de si la función
 *       «copiar», invocada con el argumento «numero», realiza una copia
 *       correcta de su argumento de entrada. En caso negativo, informa 
 *       también acerca del valor incorrecto que devuelve la función.
 */
 ...
 *       de cifras de «numero».
 * Post: Escribe un mensaje en pantalla informando acerca de si la función
 *       «numCifras», invocada con el argumento «numero», calcula el
 *       valor correcto «valorEsperado». En caso negativo, informa también
 *       acerca del valor incorrecto que devuelve la función.
 */
